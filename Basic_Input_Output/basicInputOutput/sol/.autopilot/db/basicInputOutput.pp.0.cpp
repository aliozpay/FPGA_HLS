# 1 "basicInputOutput/basicInputOutput.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "basicInputOutput/basicInputOutput.cpp" 2
...
# 3 "basicInputOutput/basicInputOutput.cpp" 2

__attribute__((sdx_kernel("basicInputOutput", 0))) void basicInputOutput(ap_int<4> input, ap_int<4> *output){
#line 13 "D:/FPGA_HLS/Basic_Input_Output/basicInputOutput/sol/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=basicInputOutput
# 4 "basicInputOutput/basicInputOutput.cpp"
