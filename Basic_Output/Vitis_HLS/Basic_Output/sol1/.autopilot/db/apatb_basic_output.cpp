...
// wrapc file define:
#define AUTOTB_TVIN_o "../tv/cdatafile/c.basic_output.autotvin_o.dat"
#define AUTOTB_TVOUT_o "../tv/cdatafile/c.basic_output.autotvout_o.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_o "../tv/rtldatafile/rtl.basic_output.autotvout_o.dat"
...
extern "C"
void basic_output_hw_stub_wrapper(void*);

extern "C"
void apatb_basic_output_hw(void* __xlx_apatb_param_o)
{
  static hls::sim::Register port0 {
    .name = "o",
    .width = 3,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_o),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_o),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_o),
#endif
  };
  port0.param = __xlx_apatb_param_o;
  ...
  try {
    ...
    basic_output_hw_stub_wrapper(__xlx_apatb_param_o);
