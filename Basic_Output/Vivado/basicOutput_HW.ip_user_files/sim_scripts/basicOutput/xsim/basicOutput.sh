...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot basicOutput xil_defaultlib.basicOutput -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  basicOutput -key {Behavioral:sim_1:Functional:basicOutput} -tclbatch cmd.tcl -protoinst "protoinst_files/basicOutput.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb basicOutput.wdb xsim.dir)
